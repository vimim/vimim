...
function! s:vimim_get_antonym_list()
    let antonym = "  ，。 “” ‘’ ＋－ （） 【】 〖〗 《》 金石
    \ 阴阳 龙凤 雌雄 男女 穿脱 屄屌 淫娼 嫁娶 爱恨 死活 悲欢 离合
    \ 软硬 强弱 里外 上下 左右 前后 快慢 轻重 缓急 正反 坤乾 日月
    \ 始终 胖瘦 迎送 盈亏 钝锐 升降 进退 开关 藏露 醒睡 跌涨 真假
    ...
    \ 收放 输赢 逆顺 灵笨 忠奸 纵横 破立 劣优 对错 纯杂 臣君 懒勤
    \ 薄厚 尊卑 文武 推拉 问答 主仆 深浅 牡牝 卷舒 贵贱 买卖 彼此
    \ 聚散 干湿 生熟 单双 首尾 奢简 警匪 官民 可否 信疑 老嫩 凹凸"
